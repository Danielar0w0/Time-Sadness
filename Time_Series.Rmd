...
### 2.6 ACF and PACF Analysis for Model Identification

```{r acf-pacf-analysis, fig.width=12, fig.height=8}
# ACF and PACF analysis for original and differenced series
par(mfrow = c(2, 2))

# Original series
acf(python_ts, main = "ACF: Original Python Series", lag.max = 40)
pacf(python_ts, main = "PACF: Original Python Series", lag.max = 40)

# First differenced series (for stationarity)
python_diff <- diff(python_ts)
acf(python_diff, main = "ACF: First Differenced Series", lag.max = 40)
pacf(python_diff, main = "PACF: First Differenced Series", lag.max = 40)

par(mfrow = c(1, 1))
```

### 2.7 Differencing for Stationarity

```{r differencing-analysis}
...
plot(python_diff, main = "First Differenced Series", ylab = "Difference")
par(mfrow = c(1, 1))
```
