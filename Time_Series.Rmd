...
### 2.8 ACF/PACF Analysis of Differenced Series

```{r differenced-acf-pacf}
# ACF and PACF analysis of differenced series for model identification
par(mfrow = c(3, 2))

# Regular differenced series
acf(python_diff, main = "ACF: Regular Differenced", lag.max = 40, na.action = na.pass)
pacf(python_diff, main = "PACF: Regular Differenced", lag.max = 40, na.action = na.pass)

# Seasonally differenced series
acf(python_seasonal_diff, main = "ACF: Seasonally Differenced", lag.max = 40, na.action = na.pass)
pacf(python_seasonal_diff, main = "PACF: Seasonally Differenced", lag.max = 40, na.action = na.pass)

# Double differencing (both seasonal and regular) - primary series for model identification
acf(python_both_diff, main = "ACF: Both Differences", lag.max = 40, na.action = na.pass)
pacf(python_both_diff, main = "PACF: Both Differences", lag.max = 40, na.action = na.pass)

par(mfrow = c(1, 1))
```

### 2.9 Data Splitting for Model Development
